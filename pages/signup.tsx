                ...
                <Box
                    ...
                    <Stack spacing={4}>
                        <HStack spacing={4} justify={"center"}>
                            ...
                            <Switch id='isOrdering' colorScheme={'red'}
                        ...
                        <FormControl id="organization" display={isOrdering ? 'block' : 'none'}>
                        ...
                        <HStack pt={6} justifyContent={"center"}>
                            ...
                            <NextLink href={'signin'}><Text color={'#ff7551'}>Login</Text></NextLink>
                        </HStack>
                    </Stack>
                </Box>
            </Stack>
